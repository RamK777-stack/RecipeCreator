...
const PersonalizationForm: React.FC<PersonalizationFormProps> = ({ loading, onSubmitForm }) => {
                ...
                <Collapsible open={open} onOpenChange={setOpen}>
                    <CollapsibleTrigger>
                        <div className="flex mb-4 items-center space-x-4">
                            ...
                            {open ? <CaretUpIcon className='h-6 w-6 mt-1' /> : <CaretDownIcon className='h-6 w-6 mt-1' />}
                        </div>
                    </CollapsibleTrigger>
